                ...
                <div className="col-lg-6">
                    <div className={`${style['signin-container']} mb-4`}>
                        ...
                        <Link to="/"><div className="d-lg-none mb-3"><FontAwesomeIcon icon="fa-arrow-left" className={`${style['fa-arrow-left']}`}/></div></Link>
                            ...
                            <button type="submit" className={`${style['btn_primary']} btn mt-3 mb-4`}>Sign In</button>
                            <p className={style.signin_text}>Don't have an account? <Link to="/register" className={`${style['redirect-text']}`} data-testid="button">Register Now</Link></p>
                        </form>
                    </div>
                </div>
            </div>
